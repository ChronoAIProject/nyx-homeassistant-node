...
- Bump bundled nyxid agent to 0.30.0 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.32

- Bump bundled nyxid agent to 0.29.0 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.31

- Bump bundled nyxid agent to 0.28.0 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.30

- Bump bundled nyxid agent to 0.27.0 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.29

- Bump bundled nyxid agent to 0.26.0 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.28

- Bump bundled nyxid agent to 0.23.2 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.27

- Bump bundled nyxid agent to 0.22.0 (auto-bumped by watch-nyxid workflow).

## 1.1.1-alpha.26

- Bump bundled nyxid agent to 0.20.1 (auto-bumped by watch-nyxid workflow).
...
- Bump bundled nyxid agent to 0.18.0 (auto-bumped by watch-nyxid workflow).
